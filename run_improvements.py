...
for problem_type in ProblemType:
    t =[ 
        ...
        TaskEvaluateGradientBoostingClassifier(max_vocab_size=100000, input_src_path=source, problem_type=problem_type, oversampling_enabled=False, undersampling_enabled=False, ratio_after_undersampling=0.5, learning_rate=0.2, n_estimators=200, subsample=1.0),
